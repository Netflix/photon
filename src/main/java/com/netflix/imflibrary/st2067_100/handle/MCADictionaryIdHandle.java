...
@Immutable
public class MCADictionaryIdHandle extends Handle {
    private final Composition.VirtualTrack virtualTrack;
    private final UL mcaLabelDictionaryId;

    public MCADictionaryIdHandle(String handle, Composition.VirtualTrack virtualTrack, UL mcaLabelDictionaryId) {
        super(handle);
    ...
    public UL getMcaLabelDictionaryId() {
