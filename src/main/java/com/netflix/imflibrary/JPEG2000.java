    ...
    public static boolean isIMF8KProfile(UL pictureEssenceCoding) {
        ...
        if (pictureEssenceCoding.getByte(14) == 0x04) {
            ...
            switch (pictureEssenceCoding.getByte(15)) {
                ...
                case 0x0b: /* J2K_8KIMF_SingleTileLossyProfile_M5S0 */
            ...
            switch (pictureEssenceCoding.getByte(15)) {
                ...
                case 0x21: /* J2K_8KIMF_SingleMultiTileReversibleProfile_M9S0 */
                case 0x29: /* J2K_8KIMF_SingleMultiTileReversibleProfile_M10S0 */
                    return true;
            }
        }
