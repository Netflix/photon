...
public class IMFMGASADMPluginConstraintsValidator implements ConstraintsValidator {
    ...
    public List<ErrorLogger.ErrorObject> validateCompositionConstraints(@Nonnull IMFCompositionPlaylist imfCompositionPlaylist, @Nonnull List<PayloadRecord> headerPartitionPayloads) {
        ...
        imfErrorLogger.addAllErrors(IMFMGASADMConstraintsChecker.checkMGASADMVirtualTrackParameterSet(imfCompositionPlaylist));

        // ST 2067-203 MGASADMVirtualTrack checks
        imfErrorLogger.addAllErrors(IMFMGASADMConstraintsChecker.checkMGASADMVirtualTrack(editRate, virtualTrackMap, essenceDescriptorListMap, Set.of()));
