...
public class IMFIABConstraintsChecker {
    ...
    public static List<ErrorLogger.ErrorObject> checkIABVirtualTrack(Composition.EditRate compositionEditRate,
        ...
        for(IMFBaseResourceType baseResource : virtualTrackResourceList) {
            ...
            if (!domNodeObjectModel.getFieldAsUL("ContainerFormat").equalsWithMask(IMF_IAB_ESSENCE_CLIP_WRAPPED_CONTAINER_UL, 0b1111111011111111)) {
                imfErrorLogger.addError(IMFErrorLogger.IMFErrors.ErrorCodes.IMF_CORE_CONSTRAINTS_ERROR, IMFErrorLogger.IMFErrors.ErrorLevels.NON_FATAL, String.format("EssenceDescriptor ID %s referenced by " +
            ...
            if (!domNodeObjectModel.getFieldAsUL("SoundCompression").equalsWithMask(IMMERSIVE_AUDIO_CODING_LABEL, 0b1111111011111111)) {
                imfErrorLogger.addError(IMFErrorLogger.IMFErrors.ErrorCodes.IMF_CORE_CONSTRAINTS_ERROR, IMFErrorLogger.IMFErrors.ErrorLevels.NON_FATAL, String.format("EssenceDescriptor ID %s referenced by " +
...
//                                }
                            if (!IABSoundfieldLabelSubDescriptor.IAB_MCA_LABEL_DICTIONNARY_ID_UL.equalsWithMask(subentry.getKey().getFieldAsUL("MCALabelDictionaryID"), 0b1111111011111111)) {
                                imfErrorLogger.addError(IMFErrorLogger.IMFErrors.ErrorCodes.IMF_CORE_CONSTRAINTS_ERROR, IMFErrorLogger.IMFErrors.ErrorLevels.NON_FATAL, String.format("EssenceDescriptor ID %s referenced by " +
