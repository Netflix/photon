...
public final class IABSoundfieldLabelSubDescriptor extends GenericDescriptor {
    ...
    public static final byte [] IAB_MCA_LABEL_DICTIONNARY_ID_KEY = { 0x06, 0x0E, 0x2B, 0x34, 0x04, 0x01, 0x01, 0x0D, 0x03, 0x02, 0x02, 0x21, 0x00, 0x00, 0x00, 0x00 };
    ...
    public String getRFC5646SpokenLanguage(){
        return this.iabSoundfieldLabelSubDescriptorBO.rfc_5646_spoken_language;
    }
