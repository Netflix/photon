            ...
            if (sequence == null) {
                ...
                if (genericDescriptor instanceof IABEssenceDescriptor) { // Support for st2067-201
                    ...
                    if (conformsToSpecifications == null) {
                        ...
                        } else if (!UL.containsWithMask(specificationsULs, IABEssenceDescriptor.IMF_IAB_TRACK_FILE_LEVEL0_UL, 0b1111111011111111)) {
                            imfErrorLogger.addError(IMFErrorLogger.IMFErrors.ErrorCodes.IMF_CORE_CONSTRAINTS_ERROR, IMFErrorLogger.IMFErrors.ErrorLevels.NON_FATAL, IMF_IAB_EXCEPTION_PREFIX +
                    ...
                    // Section 5.9
                    if (!iabEssenceDescriptor.getEssenceContainerUL().equalsWithMask(IABEssenceDescriptor.IMF_IAB_ESSENCE_CLIP_WRAPPED_CONTAINER_UL, 0b1111111011111111)) {
                        imfErrorLogger.addError(IMFErrorLogger.IMFErrors.ErrorCodes.IMF_CORE_CONSTRAINTS_ERROR, IMFErrorLogger.IMFErrors.ErrorLevels.NON_FATAL, IMF_IAB_EXCEPTION_PREFIX +
                    ...
                    if (!iabEssenceDescriptor.getSoundEssenceCoding().equalsWithMask(IABEssenceDescriptor.IMMERSIVE_AUDIO_CODING_LABEL, 0b1111111011111111)) {
                    ...
                    if (subDescriptors.size() == 0) {
                        ...
                        if (iabSoundFieldLabelSubDescriptors.size() != 1) {
                            ...
                            if (iabSoundFieldLabelSubDescriptorBO.getMCALabelDictionnaryId() == null) {
                                ...
                                // Section 5.10.4
                                if (!iabSoundFieldLabelSubDescriptorBO.getMCALabelDictionnaryId().equalsWithMask(IABSoundfieldLabelSubDescriptor.IAB_MCA_LABEL_DICTIONNARY_ID_UL, 0b1111111011111111)) {
                                    imfErrorLogger.addError(IMFErrorLogger.IMFErrors.ErrorCodes.IMF_CORE_CONSTRAINTS_ERROR, IMFErrorLogger.IMFErrors.ErrorLevels.FATAL, IMF_IAB_EXCEPTION_PREFIX +
