...
public final class IMFCoreConstraintsChecker_st2067_2_2016
{
    ...
    public static boolean checkVirtualTracks(org.smpte_ra.schemas.st2067_2_2016.CompositionPlaylistType compositionPlaylistType, Map<UUID, ? extends Composition.VirtualTrack> virtualTrackMap, IMFErrorLogger imfErrorLogger){
        ...
        while(iterator.hasNext()) {
            ...
            if (virtualTrack.getSequenceTypeEnum().equals(Composition.SequenceTypeEnum.MainImageSequence)) {
                ...
                for (org.smpte_ra.schemas.st2067_2_2016.TrackFileResourceType trackFileResourceType : virtualTrackResourceList) {
    ...
    public static void checkSegments(org.smpte_ra.schemas.st2067_2_2016.CompositionPlaylistType compositionPlaylistType, Map<UUID, CompositionModel_st2067_2_2016.VirtualTrack_st2067_2_2016> virtualTrackMap, @Nullable IMFErrorLogger imfErrorLogger)
    {
    ...
    public static boolean checkVirtualTrackResourceList(UUID trackID, List<org.smpte_ra.schemas.st2067_2_2016.TrackFileResourceType> virtualTrackResourceList, @Nonnull IMFErrorLogger imfErrorLogger){
        boolean result = true;
