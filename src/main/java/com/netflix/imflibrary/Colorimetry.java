...
public enum Colorimetry {
    ...
    public static enum CodingEquation {
        ...
        public static @Nonnull CodingEquation valueOf(@Nullable UL codingEquationUL) {
            for(CodingEquation codingEquation: CodingEquation.values()) {
                if( codingEquation.getCodingEquationUL() != null && codingEquationUL != null && codingEquation.getCodingEquationUL().equalsWithMask(codingEquationUL, 0b1111111011111111)) {
                    return codingEquation;
                }
            }
            return Unknown;
    ...
    public static enum TransferCharacteristic {
        ...
        HLG(UL.fromULAsURNStringToUL("urn:smpte:ul:06.0E.2B.34.04.01.01.0D.04.01.01.01.01.0B.00.00")),
        ...
        public static @Nonnull TransferCharacteristic valueOf(@Nullable UL transferCharacteristicUL) {
            for(TransferCharacteristic transferCharacteristic: TransferCharacteristic.values()) {
                if( transferCharacteristic.getTransferCharacteristicUL() != null && transferCharacteristicUL != null && transferCharacteristic.getTransferCharacteristicUL().equalsWithMask(transferCharacteristicUL, 0b1111111011111111)) {
                    return transferCharacteristic;
                }
            }
            return Unknown;
    ...
    public static enum ColorPrimaries {
        ...
        public static @Nonnull ColorPrimaries valueOf(@Nullable UL colorPrimariesUL) {
            for(ColorPrimaries colorPrimaries: ColorPrimaries.values()) {
                if( colorPrimaries.getColorPrimariesUL() != null && colorPrimariesUL != null && colorPrimaries.getColorPrimariesUL().equalsWithMask(colorPrimariesUL, 0b1111111011111111)) {
