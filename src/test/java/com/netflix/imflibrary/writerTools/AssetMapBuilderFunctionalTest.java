...
public class AssetMapBuilderFunctionalTest {
    ...
    public void assetMapBuilderTest() throws IOException, SAXException, JAXBException, URISyntaxException {
        ...
        List<ErrorLogger.ErrorObject> errors = IMPValidator.validateAssetMap(new PayloadRecord(new FileByteRangeProvider(assetMapFile).getByteRangeAsBytes(0, assetMapFile.length()-1), PayloadRecord.PayloadAssetType.AssetMap, 0L, 0L));
